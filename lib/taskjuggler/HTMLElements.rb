...
class TaskJuggler
  ...
  module HTMLElements
    ...
    htmlTags = %w( a b base body br code col colgroup div em frame frameset
                   footer h1 h2 h3 head html hr meta p pre table td title tr )
    # A list of HTML tags that are self-closing.
    closureTags = %w( area base basefont br frame hr input img link meta )
